  ...
  return (
    <div className="fixed bottom-24 right-4 z-30 flex flex-col items-center gap-3 sm:right-6">
      <a
        ...
        className="flex h-14 w-14 animate-scale-in items-center justify-center rounded-full bg-gradient-to-br from-[#feda75] via-[#d62976] to-[#4f5bd5] text-white shadow-lg shadow-black/30 transition-transform duration-200 hover:scale-110 hover:rotate-6 hover:brightness-95 active:scale-90 [animation-delay:80ms]"
      >
      ...
      <a
        ...
        className="relative flex h-14 w-14 animate-scale-in items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/30 transition-transform duration-200 hover:scale-110 hover:brightness-95 active:scale-90"
      >
        <span
          aria-hidden
