  ...
  return (
    <div className="fixed bottom-24 right-4 z-30 flex flex-col items-center gap-3 sm:right-6">
      <a
        ...
        className="flex h-12 w-12 animate-scale-in items-center justify-center rounded-full bg-gradient-to-br from-[#feda75] via-[#d62976] to-[#4f5bd5] text-white shadow-lg shadow-black/30 transition hover:brightness-95 active:scale-90 [animation-delay:80ms]"
      >
